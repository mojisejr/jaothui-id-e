...
/**
 * Staff Creation Page - Jaothui ID-Trace System
 *
 * Complete page for creating new staff accounts for farm owners.
 *
 * Features:
 * - Protected route (authentication required)
 * - Owner-only access (farm owner verification)
 * - Integration with CreateStaffForm component
 * - Farm validation
 ...
 * @see /src/app/animals/create/page.tsx - Pattern reference
 */
...
export default function CreateStaffPage() {
  ...
  /**
   * Fetch farm when user is authenticated
  ...
  const handleSuccess = (staff: any) => {
    ...
    window.alert("เพิ่มพนักงานสำเร็จแล้ว");
